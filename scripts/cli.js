...
const contractABI = require("../artifacts/contracts/Llamaindexai.sol/Llamaindexai.json").abi;

program
    .name("llamaindexai-cli")
    .description("CLI tool for Llamaindexai smart contract")
    .version("1.0.0");
